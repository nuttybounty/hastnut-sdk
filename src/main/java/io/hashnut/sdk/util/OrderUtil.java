...
public class OrderUtil {
    ...
    public static List<CoinInfo> queryAllCoinInfo() throws IOException {
        ...
        Response<List<CoinInfo>> response= JSONObject.parseObject(result,new TypeReference<Response<List<CoinInfo>>>(){});
    ...
    public static List<ChainInfo> queryAllChainInfo() throws IOException {
        ...
        Response<List<ChainInfo>> response= JSONObject.parseObject(result,new TypeReference<Response<List<ChainInfo>>>(){});
    ...
    public static List<LegalTender> queryAllSupportLegalTender() throws IOException {
        ...
        Response<List<LegalTender>> response= JSONObject.parseObject(result,new TypeReference<Response<List<LegalTender>>>(){});
    ...
    public static List<FliatExchangeRate> queryFliatExchange(String baseCoin, String quoteCoin, String chainCode) throws IOException {
        ...
        Response<List<FliatExchangeRate>> response= JSONObject.parseObject(result,new TypeReference<Response<List<FliatExchangeRate>>>(){});
    ...
    public static OrderOutputParam createPayOrderWithCustomCallBackUrl(PayOrder input, String requestKey,int serviceType,String serviceVersion,int serviceId,String extra) throws OrderException, IOException {
        Map<String,Object> paramMap=new HashMap<>();
        paramMap.put("chain",input.getChain());
        paramMap.put("mchAddress",input.getMchAddress());
        paramMap.put("accessKeyId",input.getAccessKeyId());
        ...
        paramMap.put("receiptContractAddress",input.getReceiptAddress());
        paramMap.put("accessChannel", input.getAccessChannel());
        paramMap.put("customCallBackUrl",true);
